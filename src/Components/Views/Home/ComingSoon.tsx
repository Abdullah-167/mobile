...
function Arrow(props: any) {
    ...
    return (
        <svg
            ...
            className={`max-w-[40px] bg-gray-500 bg-opacity-50 rounded-full p-3 cursor-pointer absolute ${props.left ? "arrow--left top-[150px] sm:top-[170px] -left-4 z-[1000]" : "arrow--right top-[170px] -right-4 z-[1000]"
                } ${disabeld}`}
