    ...
    return (
        <section className="relative py-8">
            <div className="max-w-[1000px] mx-auto px-5">
                <h2 className='text-xl font-extrabold text-center pb-6'>Featured Mobile Comparisons</h2>
...
function Arrow(props: any) {
    ...
    return (
        <svg
            ...
            className={`max-w-[40px] bg-gray-500 bg-opacity-50 rounded-full p-3 cursor-pointer absolute ${props.left ? "arrow--left -top-[160px] sm:-top-[140px] lg:-top-[145px] -left-4 z-[1000]" : "arrow--right -top-[160px] sm:-top-[140px] lg:-top-[145px] -right-4 z-[1000]"
                } ${disabeld}`}
