...
function Arrow(props: any) {
    ...
    return (
        <svg
            ...
            className={`max-w-[40px] bg-gray-500 bg-opacity-50 sm:flex hidden rounded-full p-3 cursor-pointer absolute ${props.left ? "arrow--left top-[175px] left-8 z-[1000]" : "arrow--right top-[175px] right-8 z-[1000]"
                } ${disabeld}`}
