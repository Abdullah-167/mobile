                            ...
                            <div className='grid lg:grid-cols-4 gap-3 w-full' key={index}>
                                <div className='relative shadow-md col-span-3 max-h-[490px] overflow-hidden cursor-pointer' key={index}>
                                    ...
                                    <div className=' absolute bottom-7 left-4 md:left-7  text-white '>
                                        <p className='text-xl md:text-3xl max-w-[600px] font-semibold pb-4'>{item.heading}</p>
                                        <span>{item.author} - {item.date}</span>
                                    </div>
                                </div>
                                <div className='flex justify-center gap-6 lg:block'>
                                    {item.sideCards.map((newitem, idx) => {
                                        return (
                                            <div className='shadow-md lg:max-w-[300px] mb-2 overflow-hidden cursor-pointer' key={idx}>
                                                ...
                                                <p className='text-sm max-w-[600px] mx-auto font-semibold pb-4 px-2'>{newitem.heading}</p>
                                            </div>
                                        )
                                    })}
                                </div>
