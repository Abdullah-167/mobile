        ...
        <section>
            <div>
                ...
                <div className='flex flex-wrap lg:flex-nowrap gap-12'>
                    <div>
                        <h2 className='text-3xl font-semibold text-primary border-b-2 border-b-primary pb-1 mt-14 mb-5'>Latest Articles</h2>
                            ...
                            {latestArticle.map((item, index) => {
                                return (
                                    <div key={index}>
                                        <div >
                                            <div className='blog-heading overflow-hidden'>
                                                <Image className=' cursor-pointer transition-all duration-500 hover:scale-105 max-h-[302px] pb-3 object-cover' src={item.bigImage} alt={'card-image'} width={800} height={800} />
                                                <p className=' font-semibold pb-1'>{item.heading}</p>
                                                <span className=' text-sm text-gray-500'>{item.author} - {item.date}</span>
                                            </div>
                                        </div>
                                    </div>
                                )
                    ...
                    <div>
                        <h2 className='text-3xl font-semibold text-primary border-b-2 border-b-primary pb-1 mt-14 mb-5'>Trending News</h2>
                        <div className=''>
                            {trendingNews.map((item, index) => {
                                return (
                                    <div className='flex  blog-heading overflow-hidden pb-3'
                                        key={index}>
                                        <div>
                        ...
                        <div>
                            ...
                            {popularPhones.map((item, index) => {
                                return (
                                    <li className=' font-semibold list-disc hover:text-primary cursor-pointer pb-2 text-sm ml-4' key={index}>{item.mobiles}</li>
                                )
                            })}
                        </div>
                        <div>
                        ...
                        <div>
                            <h2 className='text-3xl font-semibold text-primary border-b-2 border-b-primary pb-1 mt-14 mb-5'>How TO</h2>
                            <div className=''>
