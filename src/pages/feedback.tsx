                ...
                <div className='flex w-full'>
                    ...
                    <div className='flex-grow'>
                        <div className='max-w-[700px] mx-auto'>
                            <h1 className=' text-center text-5xl text-primary font-semibold pt-10 pb-10'>Feedback </h1>
                            ...
                            <p className='pb-2 text-2xl font-semibold'>  <span className=' font-semibold pb-2'></span> Thank You for Your Feedback</p>
